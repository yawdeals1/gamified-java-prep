/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cb1ac4c56fa1209c2a52abaca54f7d84)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAILER_SECRET">> {}
}
